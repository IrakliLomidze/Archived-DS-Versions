...
namespace ILG.Codex.CodexR4.DocumentForm
{
	...
	public partial class FileHandler {
		...
		const TXTextControl.StreamType DefaultSaveTypes = TXTextControl.StreamType.All | TXTextControl.StreamType.InternalUnicodeFormat & ~DefaultExportTypes & ~TXTextControl.StreamType.XMLFormat;
		const TXTextControl.StreamType DefaultInsertTypes = TXTextControl.StreamType.All & ~DefaultExportTypes;
