...
namespace ILG.Codex.Codex2007
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if ((ww < 800) || (hh < 600))
            {
                ILG.Windows.Forms.ILGMessageBox.Show("კოდექს 2007 ის გასაშვებად ეკრანზე წერტილების \nრაოდენობა უნდა იყოს მინიმუმ" +
            ...
            s_Mutex1 = new Mutex(true, "Codex2007DOTNETUpdater");
            ...
            {
                string ss = System.Environment.CurrentDirectory + "\\cngen.747";
