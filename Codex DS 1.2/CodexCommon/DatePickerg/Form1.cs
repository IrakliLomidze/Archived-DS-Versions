...

		{
			...
			public class PickDate : System.Windows.Forms.Form
			{
				...
				public PickDate(DateTime initv)
				{
					...
					comboBoxMonth.Items.Add("июмеюри");
					comboBoxMonth.Items.Add("хдадреюки");
					comboBoxMonth.Items.Add("люрти");
					comboBoxMonth.Items.Add("юприки");
					comboBoxMonth.Items.Add("люиси");
					comboBoxMonth.Items.Add("иемиси");
					comboBoxMonth.Items.Add("иекиси");
					comboBoxMonth.Items.Add("юбеисто");
					comboBoxMonth.Items.Add("сдьтдладри");
					comboBoxMonth.Items.Add("оьтоладри");
					comboBoxMonth.Items.Add("модладри");
					comboBoxMonth.Items.Add("цдйдладри");
					...
					//int w = (int)gfx.MeasureString("цыдс: 28 хдадреюки 2004",this.Font).Width;

					

					int w2 = (int)gfx.MeasureString(" хдадреюки ",this.Font).Width;
					...
					this.ultraButton3.Text = "цыдс: "+DateToString(DateTime.Now);// 28 хдадреюки 2004";
				...
				private static String MonthToString(int Month)
				{
					...
					switch (Month) 
					{
						case 1 : Str ="июмеюри"; break;
						case 2 : Str ="хдадреюки"; break;
						case 3 : Str ="люрти"; break;
						case 4 : Str ="юприки"; break;
						case 5 : Str ="люиси"; break;
						case 6 : Str ="иемиси"; break;
						case 7 : Str ="иекиси"; break;
						case 8 : Str ="юбеисто"; break;
						case 9 : Str ="сдьтдладри"; break;
						case 10: Str ="оьтоладри"; break;
						case 11: Str ="модладри"; break;
						case 12: Str ="цдйдладри"; break;
					}
					return Str;
				...
				private static int  StringToMonth(String Month)
				{
					...
					switch (Month) 
					{
						case "июмеюри"   : Ret = 1; break;
						case "хдадреюки" : Ret = 2; break;
						case "люрти"     : Ret = 3; break;
						case "юприки"    : Ret = 4; break;
						case "люиси"     : Ret = 5; break;
						case "иемиси"    : Ret = 6; break;
						case "иекиси"    : Ret = 7; break;
						case "юбеисто"   : Ret = 8; break;
						case "сдьтдладри": Ret = 9; break;
						case "оьтоладри" : Ret = 10; break;
						case "модладри"  : Ret = 11; break;
						case "цдйдладри" : Ret = 12; break;
					}
					return Ret;
