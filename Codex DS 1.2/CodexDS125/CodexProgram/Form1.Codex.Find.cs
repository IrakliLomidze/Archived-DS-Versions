...
namespace ILG.Codex.Codex2007
{
    partial class Form1
    {
        ...
        private void Codex_Autor_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexDS_DAuthor"], 0, "A_ID", "C_AUTHOR", "A_Caption", "მიმღები ორგანო", " ", dc.X, dc.Y, Codex_Autor_Edit.Width + Codex_Autor_Button.Width);
        ...
        private void Codex_Type_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexDS_DType"], 0, "T_ID", "C_Type", "T_Caption", "დოკუმენტის სახე", " ", dc.X, dc.Y, Codex_Type_Edit.Width + Codex_Type_Button.Width);
        ...
        private void Codex_Subject_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.                                                      
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexDS_DSubject"], 0, "S_ID", "C_Subject", "S_Caption", "თემატიკა", " ", dc.X, dc.Y, Codex_Subject_Edit.Width + Codex_Subject_Button.Width);
        ...
        private void Codex_Word_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexDS_DWords"], 1, "W_ID", "C_Words", "W_Caption", "საკვანძო სიტყვა/ები", " ", dc.X, dc.Y, Codex_Word_Edit.Width + Codex_Word_Button.Width);
        ...
        private void Codex_Category_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexDS_DCategory"], 0, "C_ID", "C_Category", "C_Caption", "დოკუმენტის კატეგორია", " ", dc.X, dc.Y, Codex_Category_Edit.Width + Codex_Category_Button.Width);
        ...
        private void Codex_Status_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexDS_DStatus"], 0, "C_ID", "C_Status", "C_Caption", "დოკუმენტის სტატუსი", " ", dc.X, dc.Y, Codex_Status_Edit.Width + Codex_Status_Button.Width);
        ...
        private String Codex_GenerateFindSQL()
        {
            ...
            {
                bool UseFullTest = global::ILG.Codex.Codex2007.Properties.Settings.Default.UseFullTextSearch;
