    ...
    partial class Form1
    {
        ...
        private void LoadTree()
        {
           ...
           // UltraTreeNode DocumentNode;
            ...
            UltraTree1.ImageList = ImageList1;
            return;
        ...
        private void LoadTreeData()
        {
            ...
            if (ActiveProgram == 2) { FavoritesFile = "Codex2007DS.Favorites.XML"; }
            if (ActiveProgram == 1) { FavoritesFile = "CGL2007.Favorites.XML"; }
            if (ActiveProgram == 0) { FavoritesFile = "ICG2007.Favorites.XML"; }

            //FavoritesFile = "Codex2007DS.Favorites.XML";

            string s1 = global::ILG.Codex.Codex2007.Properties.Settings.Default.CodexFavoritesDir + "\\" + FavoritesFile;
            if (System.IO.File.Exists(s1) == true)
            {
                UltraTree1.LoadFromXml(s1);
            }
            else
            {
        ...
        private void SaveTreeData()
        {
            ...
            if (ActiveProgram == 0) { FavoritesFile = "ICG2007.Favorites.XML"; }
            //FavoritesFile = "Codex2007DS.Favorites.XML";
            if (FavoritesFile == "") return;
            if (System.IO.Directory.Exists(global::ILG.Codex.Codex2007.Properties.Settings.Default.CodexFavoritesDir) == false)
                System.IO.Directory.CreateDirectory(global::ILG.Codex.Codex2007.Properties.Settings.Default.CodexFavoritesDir);
            string s1 = global::ILG.Codex.Codex2007.Properties.Settings.Default.CodexFavoritesDir + "\\" + FavoritesFile;
        ...
        private void AddtoFavorites(int ID, string tcaption, string dcaption)
        {
            ...
            string ss = "";
            if (ActiveProgram == 2) { ss = "Codex"; }
            if (ActiveProgram == 1) { ss = "CGL"; }
            if (ActiveProgram == 0) { ss = "ICG"; }
        ...
        private void ClickFavorites()
        {
            ...
            if (s.Length > 9)
            {
                ...
                {
                    case 2: ShowInNewWindows(2, ID_FAV, "", ""); break;
                    case 1: ShowInNewWindows(1, ID_FAV, "", ""); break;
                    case 0: ShowInNewWindows(0, ID_FAV, "", ""); break;
                }
            }
...
//===================================================================================================================
        ...
        private void SaveHistoryData()
        {
            this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
            string FavoritesFile = "";
            if (ActiveProgram == 2) { FavoritesFile = "CodexDS2007.History.xml"; }
            if (ActiveProgram == 1) { FavoritesFile = "CGL2007.History.xml"; }
            if (ActiveProgram == 0) { FavoritesFile = "ICG2007.History.xml"; }

            if (FavoritesFile == "") return;
            if (System.IO.Directory.Exists(global::ILG.Codex.Codex2007.Properties.Settings.Default.CodexFavoritesDir) == false)
                System.IO.Directory.CreateDirectory(global::ILG.Codex.Codex2007.Properties.Settings.Default.CodexFavoritesDir);
            string s1 = global::ILG.Codex.Codex2007.Properties.Settings.Default.CodexFavoritesDir + "\\" + FavoritesFile;
            UltraTree2.SaveAsXml(s1);
            this.Cursor = System.Windows.Forms.Cursors.Default;
