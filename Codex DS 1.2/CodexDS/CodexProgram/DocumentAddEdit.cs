...
namespace ILG.Codex.Codex2007
{
    public partial class DocumentAddEdit : Form
    {
        ...
        string SellectedPDF = "";
        private TXTextControl.HeaderFooter m_ActiveHeaderFooter;
        DataSet DS;
        DateTime Dt;
        int DocumentMode = -1;
        ...
        public void NewDocumentMode()
        {
            ...
            CLinkGrid.DisplayLayout.Bands[0].Columns["Order"].AutoEdit = false;
            ...
            CLinkGrid.DisplayLayout.Bands[0].Columns["Type"].AutoEdit = false;
            ...
            CLinkGrid.DisplayLayout.Bands[0].Columns["access"].AutoEdit = false;
            ...
            CLinkGrid.DisplayLayout.Bands[0].Columns["Link"].AutoEdit = false;
            ...
            CLinkGrid.DisplayLayout.Bands[0].Columns["Caption"].AutoEdit = false;
        ...
        public int EditDocumentMode(int ID)
        {
            ...
            if (DefaultDocumentFormat == 0)
            {
                ...
                textControl1.PageSize = LoadSettings.PageSize; textControl1.PageMargins = LoadSettings.PageMargins; 
        ...
        private void SaveDocument()
        {
			...
			//fd.InitialDirectory = startdir;
            fd.Filter = fd.Filter = "Microsoft Word (*.doc)|*.doc|Rich Text Format (*.rtf)|*.rtf|txt files (*.txt)|*.txt";
			if (fd.ShowDialog() == DialogResult.OK)
        ...
        void ViewLayout()
        {
            ...
            { // Page Layout
                ...
                try
                {
                    (ultraToolbarsManager1.Tools["WebView"] as Infragistics.Win.UltraWinToolbars.StateButtonTool).Checked = false;
                    (ultraToolbarsManager1.Tools["PageView"] as Infragistics.Win.UltraWinToolbars.StateButtonTool).Checked = true;
                }
                finally
                {
                    this.ultraToolbarsManager1.ToolClick += new Infragistics.Win.UltraWinToolbars.ToolClickEventHandler(this.ultraToolbarsManager1_ToolClick);
        ...
        private int detectzomfactor()
        {
            string s = "100";
            s = CodexZoomingCombo.Text.Trim();
        ...
        private int detectzoom_X(int c)
        {

            int W1 = this.textControl1.Width - SystemInformation.HorizontalScrollBarThumbWidth;
            int H1 = textControl1.Height;


            int nPageHeightInPixels = (textControl1.PageSize.Height * PixelsPerInch) / 100;
            int nPageWidthInPixels = (textControl1.PageSize.Width * PixelsPerInch) / 100;
        ...
        public void ZoomingX()
        {
            // Zooming 

            if (this.XZoomFactor == -20) { textControl1.ZoomFactor = detectzoom_X(1); }
            else
            {
                if (XZoomFactor == -10) { textControl1.ZoomFactor = detectzoom_X(2); }
                else
                {
                    textControl1.ZoomFactor = XZoomFactor;
                }
            }
            //CodexZoomingCombo.Text = this.textControl_Codex.ZoomFactor + "%";
            if (XZoomFactor == -10) CodexZoomingCombo.Text = "გვ.სიმაღლე (" + textControl1.ZoomFactor + "%)";
            else if (XZoomFactor == -20) CodexZoomingCombo.Text = "გვ.სიგანე (" + textControl1.ZoomFactor + "%)";
            else CodexZoomingCombo.Text = textControl1.ZoomFactor + "%";
        }

        // Main Zooming
        private void modify_zoomfactor(int zoom)
        {
           XZoomFactor = zoom; ZoomingX(); 
        }
        ...
        private void View_zoomfactor()
        {
              ...
              if (XZoomFactor == -10) CodexZoomingCombo.Text = "გვ.სიმაღლე";
               else if (XZoomFactor == -20) CodexZoomingCombo.Text = "გვ.სიგანე";
              else CodexZoomingCombo.Text = textControl1.ZoomFactor + "%";
            
        }

        public void CodexZoomingCombo_SelectionChangeCommitted(object sender, EventArgs e)
        {
            int i = this.detectzomfactor();
            if (i != -1) this.modify_zoomfactor(i);
        }

        public void CodexZoomingCombo_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                int i = this.detectzomfactor();
                if (i != -1) this.modify_zoomfactor(i);
                else ILG.Windows.Forms.ILGMessageBox.Show("დოკუმენტის მაშტაბის განმსაზღვრელი რიცხვი, არასწორია");
            }
        ...
        private void X_UpdateStatusBar()
        {
            ...
            CodexDocumentStatusBar.Panels[0].Text = s1;
            ...
            CodexDocumentStatusBar.Panels[1].Text = s1;
            CodexDocumentStatusBar.Panels[2].Text = ultraTextEditor1.Text;
        ...
        public void HeaderAttributes()
        {
            ...
            HeaderSettingsDialog.tx = textControl1;
        ...
        private void ultraToolbarsManager1_ToolClick(object sender, Infragistics.Win.UltraWinToolbars.ToolClickEventArgs e)
        {
            switch (e.Tool.Key)
            {
                ...
                case "PageView":    // ButtonTool
                    XViewLayout = 0; ViewLayout();
                    break;

                case "WebView":    // ButtonTool
                    XViewLayout = 1; ViewLayout();
                    break;
 ...
 //           CCategory.DisplayLayout.Grid.Width = CAuthor.Width;
        ...
        private void EditLink()
        {
            ...
            DLinks.Tables[0].Rows[L_Index]["Color"] = L_Color;
        ...
        private void DOSaveDocument()
        {
            ...
            try
            {
                ...
                if (DefaultDocumentFormat == 0)
                    ...
                    InsertDoc.Parameters["@C_DocText"].Value = DBNull.Value;
        ...
        private void DOEditDocument()
        {
            ...
            try
            {
                ...
                if (DefaultDocumentFormat == 0)
                    ...
                    UpdateDoc.Parameters["@C_DocText"].Value = DBNull.Value;
