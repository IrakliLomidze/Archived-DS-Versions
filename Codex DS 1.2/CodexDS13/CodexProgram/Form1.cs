            ...
            switch (ActiveProgram)
            {
                ...
                case 2:
                    #region Codex
                    {
                        ...
                        {
                            case 0: /* Find Form */ this.Text = Ind + "კოდექსი 2007 დოკუმენტების არქივი"; break;
                            case 1: /* List Form */ this.Text = Ind + "კოდექსი 2007 დოკუმენტების არქივი დოკუმენტების სია"; break;
