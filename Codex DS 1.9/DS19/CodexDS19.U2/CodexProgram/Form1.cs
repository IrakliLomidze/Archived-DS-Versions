...
namespace ILG.Codex.CodexR4
{
    public partial class Form1 : Form
    {
        ...
        private String GetTSQLCountHistory()
        {
            ...
            if (DSRunTimeLicense.IsRecoverDeletedDocumentsGranted() == true) return SQLFull;
            if (DSRunTimeLicense.IsHistoryExtendedAccessGranted() == true) return SQLExtended;
            if (DSRunTimeLicense.IsHistoryAccessGranted() == true) return SQLPublic;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (DSRunTimeLicense.IsConfidentialDocumentShowInList() == false)
            {
            ...
            if (DSRunTimeLicense.IsSearchinDeletedDocumentsGranted() == true)
            {
        ...
        private void CodexToolBar_ToolClick(object sender, Infragistics.Win.UltraWinToolbars.ToolClickEventArgs e)
        {
            ...
            switch (e.Tool.Key)
            {
               ...
               case "ChangeDocument":
                   ...
                   if (DSRunTimeLicense.IsDocumentEditAllow() == false)
                   {
               ...
               // Document View
                ...
                case "DeletedDocuments":
                    {
                        if (DSRunTimeLicense.IsSearchinDeletedDocumentsGranted() == false)
                        { 
            ...
            if (DSRunTimeLicense.IsHistoryAccessGranted() == true)
            {
...
//            zf3.Entries.Extract(str, fn);
  //          zf3.Close();
                    ...
                    #region Codex
                    {
                        switch ( CodexTab.ActiveTab.Index) 
                        {
                            case 0: /* Find Form */ 
                                ...
                                if (DSRunTimeLicense.IsNewDocumentAllow() == true)
                                {
                      ...
                      //  CodexToolBar.Ribbon.Tabs["RCODEX"].Groups["RCodex_History"].Visible = false;
                        ...
                        CodexToolBar.Tools["PrintMenu"].SharedProps.Enabled = true;
                              ...
                              if (DSRunTimeLicense.DocumentOperation() == true)
                              {
                                  CodexToolBar.Ribbon.Tabs["RCODEX"].Groups["XDOC"].Visible = true;
                              ...
                              if (DSRunTimeLicense.IsDocumentEditAllow() == true)
                              {
                              ...
                              if (DSRunTimeLicense.IsDocumentDeletetAllow() == true)
                              {
                                  CodexToolBar.Tools["DeleteDocument"].SharedProps.Enabled = true;
                                  CodexToolBar.Tools["DeleteDocument"].SharedProps.Visible = true;
                              }
        ...
        private void Codex_FillResult(String strcmd)
        {
            ...
            for (int i = 0; i <= Codex_Result.Tables[0].Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    {
                        if (DSRunTimeLicense.IsDocumentIDShowInList() == true) IDACCESS = "[ID=" + IDX.ToString();
                    }
                    else
                    {
                        if (DSRunTimeLicense.IsConfidentialDocumentIDShowInList() == true) IDACCESS = " [ID=" + IDX.ToString();
                    }
                }
        ...
        {
            if (DSRunTimeLicense.IsDocumentViewRestrictedMode() == true)
            {
