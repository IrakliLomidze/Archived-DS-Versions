...
namespace ILG.Codex.CodexR4
{
    ...
    internal class DSRunTimeLicense
    {
        ...
        */
        ...
        {
            #region Access Right
            AccessType f = DSRunTimeLicense.GetRights();
            switch (f)
            {
            ...
            HistoryAccessType h = DSRunTimeLicense.GetHistoryRights();
            switch (h)
            {
