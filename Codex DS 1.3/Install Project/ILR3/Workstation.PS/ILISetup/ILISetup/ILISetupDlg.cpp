...
BOOL CILISetupDlg::OnInitDialog()
{
	...
	theApp.setting_InstallationMode = 0x0000; // Worksation Mode
	...
	{
		MessageBox(_T("To install Codex.net R3 software you must be log as an Administrator"),_T("Codex.net R3 Installer"),MB_OK | MB_ICONINFORMATION);
		CDialog::OnCancel();
	}
	else
	{
