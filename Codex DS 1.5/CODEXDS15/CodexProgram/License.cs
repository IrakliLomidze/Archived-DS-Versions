...
namespace ILG.Codex.Codex2007
{
    ...
    class License
    {
        ...
        */
        ...
        {
            String fname = ILG.Codex.Codex2007.Properties.Settings.Default.CodexCurrentDirectory + "\\Role.lxs";
        ...
        {
            String fname = ILG.Codex.Codex2007.Properties.Settings.Default.CodexCurrentDirectory + "\\Rule1.rxs";
        ...
        {
            String fname = ILG.Codex.Codex2007.Properties.Settings.Default.CodexCurrentDirectory + "\\Rule2.rxs";
            if (File.Exists(fname) == false) return false;
