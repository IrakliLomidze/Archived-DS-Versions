    ...
    public partial class CodexDSListBox : UserControl
    {
        ...
        private void listBox1_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            if ((e.State & DrawItemState.Selected) == DrawItemState.Selected)
            {
                ...
                gfx.DrawImage(image1, e.Bounds.X +3, e.Bounds.Y+3, e.Bounds.Width-5, e.Bounds.Height - 5);
                ...
                if ((usestatus == true))
                {
                    if (statusLine == 1)
                    {
                        ...
                        gfx.DrawString(xcaption, captionfont, TopColor, e.Bounds.X + leftMargines + f1.Width + 8 + image2.Width + 2, e.Bounds.Y + topMargines);
                    }
                    else
                    {
                        // Original
                ...
                Rectangle rect = new Rectangle(e.Bounds.X + leftMargines + (int)f1.Width + 8 + image_Word.Width + 4, e.Bounds.Y + topMargines + (int)f1.Height + distance, this.LWithSize - leftMargines - (int)f1.Width - 8 - image_Word.Width , this.ClientSize.Height - 4); //ZXZ2
