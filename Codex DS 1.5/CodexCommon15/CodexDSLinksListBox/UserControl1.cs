        ...
        private void listBox1_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            if (ProgramName == "CODEX")
            {
                ...
                if (Visited.Rows.Contains(new object[] { linkedto }) == false)
                {
                    switch (status)
                    {
                        case 0: b = new SolidBrush(Color.FromArgb(30, 57, 91)); Ball = this.image_8; break; // Blue
                        case 1: b = new SolidBrush(Color.FromArgb(30, 57, 91)); Ball = this.image_11; break; // Gary
                        case 2: b = new SolidBrush(Color.FromArgb(30, 57, 91)); Ball = this.image_8; break; // Blue
                        case 3: b = new SolidBrush(Color.FromArgb(128, 13, 29)); Ball = this.image_9; break; // Red
