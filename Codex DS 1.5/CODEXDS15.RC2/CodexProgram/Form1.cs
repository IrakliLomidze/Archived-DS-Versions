...
namespace ILG.Codex.Codex2007
{
    public partial class Form1 : Form
    {
            ...
            #region Codex
                if (ILG.Codex.Codex2007.Properties.Settings.Default.DockDS == 1)
                {
                    try
                    {
                        ...
                        string fn = ILG.Codex.Codex2007.Properties.Settings.Default.DockSettingsPath + "\\Docks_CodexDS.bin";
        ...
        private void CodexToolBar_ToolClick(object sender, Infragistics.Win.UltraWinToolbars.ToolClickEventArgs e)
        {
            ...
            switch (e.Tool.Key)
            {
                ...
                case "GeoLat":    // ButtonTool
                    CodexR4.KeyBoard.Layout.SetGeorgianLat();
                    LanguageSwitcher.SelectedIndex = 1;
                    break;

                case "GeoRus":    // ButtonTool
                    CodexR4.KeyBoard.Layout.SetGeorgianRus();
                    LanguageSwitcher.SelectedIndex = 2;
                    break;

                case "Rus":    // ButtonTool
                    CodexR4.KeyBoard.Layout.SetRussian();
                    LanguageSwitcher.SelectedIndex = 3;
                    break;

                case "English":    // ButtonTool
                    CodexR4.KeyBoard.Layout.SetEnglish();
        ...
        private void AttachProcess()
        {
            ...
            string Suffix = "";
            string fn = Properties.Settings.Default.CodexDocumentDir + @"\"+Suffix +str;
            int i = 1;
            while (System.IO.File.Exists(fn) == true)
            {
                fn = Properties.Settings.Default.CodexDocumentDir + @"\" + i.ToString() + str;
                fn = fn.Replace("?", "_");
                i++;
            }
            ...
            if (fn.Length >= MAX_PATH)
            {
                ...
                do
                {
                    ...
                    fn = Path.Combine(Properties.Settings.Default.CodexDocumentDir, s);
                }
  ...
  //          zf3.Close();
            ...
            switch (ActiveProgram)
            {
                ...
                case 2:
                    #region Codex
                    {
                        ...
                        {
                            case 0: /* Find Form */ this.Text = Ind + "კოდექსი R3 დოკუმენტების არქივი"; break;
                            case 1: /* List Form */ this.Text = Ind + "კოდექსი R3 დოკუმენტების არქივი დოკუმენტების სია"; break;
        ...
        private void LanguageSwitcher_SelectionChanged(object sender, EventArgs e)
        {
            switch (LanguageSwitcher.SelectedIndex)
            {
                ...
                case 2:
                    ILG.Codex.CodexR4.KeyBoard.Layout.SetGeorgianRus();
                    break;

                case 3:
                    ILG.Codex.CodexR4.KeyBoard.Layout.SetRussian();
                    break;
            }
        }
        ...
        public void OpenHere()
        {
            switch (ActiveProgram)
            {
                case 2: codexListBox1_DocumentClick2(new CodexDSListEventArgs(F_Codex_DOC.CodexLinkBox.Active_LinkTo, "", ""), true); break;
                case 0: break;
            }
        }
