...
namespace ILG.Codex.Codex2007
{
    public partial class Configuration : Form
    {
        ...
        public static void createfile()
        {
            ...
            try
            {
                fs = new FileStream(ILG.Codex.Codex2007.Properties.Settings.Default.CurrentDir + @"\CodexPSDataImageCreator.Config", FileMode.Create, FileAccess.Write, FileShare.None, 1024);
            }
            catch (Exception ex)
            { // can't open outfile
        ...
        public static void loadformfile()
        {
            ...
            if (File.Exists(ILG.Codex.Codex2007.Properties.Settings.Default.CurrentDir + @"\CodexPSDataImageCreator.Config") == false)
            {
            ...
            try
            {
                ...
                fs = new FileStream(ILG.Codex.Codex2007.Properties.Settings.Default.CurrentDir + @"\CodexPSDataImageCreator.Config", FileMode.Open, FileAccess.Read, FileShare.Read, 1024);
            }
            catch (Exception ex)
            { // can't open outfile
        ...
        */
        ...
        static public void load()
        {
            ...
            string CodexDocuments = @Environment.GetFolderPath(System.Environment.SpecialFolder.Personal) + @"\Codex R3 PS Documents";
