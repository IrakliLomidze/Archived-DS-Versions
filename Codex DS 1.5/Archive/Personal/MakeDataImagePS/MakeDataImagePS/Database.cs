...
namespace ILG.Codex.Codex2007
{
	...
	public class Database
	{
		...
		public int ProcessFiles()
		{
			...
			File.Copy(Path.GetDirectoryName(ILG.Codex.Codex2007.Properties.Settings.Default.CodexDatabaseFrom)+@"\databasePS.info",ILG.Codex.Codex2007.Properties.Settings.Default.CodexDatabaseTo+@"\databasePS.info",true);
...
//			System.Windows.Forms.MessageBox.Show(srv.Databases.Item(1,"dbo").Name);
			...
			if (res1 == true)
			{
				try
				{
					Owner.ShowProgress(0,"CodexPS ბაზის დეაქტივიზაცია");
				...
				{
					Owner.ShowProgress(0,"Error: ");
					Owner.ShowProgress(0,"არ ხერხდება CodexPS-ზე ოპერირება, ბაზაზე მუშობს მომხარებელი ");
		...
		public int TakeOnlineDatabase()
		{
			...
			try
			{
				...
				Owner.ShowProgress(0,"CodexPS აქტივიზირებულია");
			}
			catch
			{
				Owner.ShowProgress(0,"Error: ");
				Owner.ShowProgress(0,"არ ხერხდება CodexPS აქტივიზაცია");
