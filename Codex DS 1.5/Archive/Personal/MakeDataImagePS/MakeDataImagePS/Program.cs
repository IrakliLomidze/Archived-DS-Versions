...
namespace ILG.Codex.Codex2007
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                ILG.Windows.Forms.ILGMessageBox.Show("კოდექსი R3 PS მონაცემთა ბაზის საინსტალაციოს გასაშვებად თქვენ უნდა გქონდეთ ადმინისტრატორის უფლებები");
                return;
            }
