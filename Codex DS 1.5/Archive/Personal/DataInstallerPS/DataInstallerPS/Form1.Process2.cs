    ...
    partial class Form1
    {
        ...
        private void getdatabasestates()
        {
            ...
            else
            {
                ...
                ultraCheckEditor3.Checked = !((srv.Databases["CodexPS"].Status & DatabaseStatus.Offline) == DatabaseStatus.Offline);

                this.act1 = this.ultraCheckEditor3.Checked;
                if (this.act1 == true) this.ultraTextEditor1.Text = srv.Databases["CodexPS"].PrimaryFilePath;
