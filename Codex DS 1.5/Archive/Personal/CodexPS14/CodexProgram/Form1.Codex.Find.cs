...
namespace ILG.Codex.Codex2007
{
    partial class Form1
    {
        ...
        {
            Codex_Date_Edit1.Text = ILG.Codex.WindowsForms.PickDate.DateToString(Codex_Date1);
            Codex_Date_Edit2.Text = ILG.Codex.WindowsForms.PickDate.DateToString(Codex_Date2);
            ...
            // Codex Info
            CodexToolBar.Tools["Codex_Info_Label1"].SharedProps.Caption = " ბაზაში არის " + LockupTables.Tables["CodexPS"].Rows[0]["C_CodexPSDocs"].ToString() + " დოკუმენტი";
            CodexToolBar.Tools["Codex_Info_Date"].SharedProps.Caption = " ბოლო განახლება (" + PickDate.DateToString((DateTime)LockupTables.Tables["CodexPS"].Rows[0]["C_Date"]) + ")";
        ...
        {
            ILG.Codex.WindowsForms.PickDate dlg2 = new ILG.Codex.WindowsForms.PickDate(Codex_Date1);
        ...
        {
            ILG.Codex.WindowsForms.PickDate dlg2 = new ILG.Codex.WindowsForms.PickDate(Codex_Date2);
        ...
        private void Codex_Autor_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexPS_DAuthor"], 0, "A_ID", "C_AUTHOR", "A_Caption", "მიმღები ორგანო", " ", dc.X, dc.Y, Codex_Autor_Edit.Width + Codex_Autor_Button.Width);
        ...
        private void Codex_Type_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexPS_DType"], 0, "T_ID", "C_Type", "T_Caption", "დოკუმენტის სახე", " ", dc.X, dc.Y, Codex_Type_Edit.Width + Codex_Type_Button.Width);
        ...
        private void Codex_Subject_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.                                                      
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexPS_DSubject"], 0, "S_ID", "C_Subject", "S_Caption", "თემატიკა", " ", dc.X, dc.Y, Codex_Subject_Edit.Width + Codex_Subject_Button.Width);
        ...
        private void Codex_Word_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexPS_DWords"], 1, "W_ID", "C_Words", "W_Caption", "საკვანძო სიტყვა/ები", " ", dc.X, dc.Y, Codex_Word_Edit.Width + Codex_Word_Button.Width);
        ...
        private void Codex_Category_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexPS_DCategory"], 0, "C_ID", "C_Category", "C_Caption", "დოკუმენტის კატეგორია", " ", dc.X, dc.Y, Codex_Category_Edit.Width + Codex_Category_Button.Width);
        ...
        private void Codex_Status_Button_Click(object sender, EventArgs e)
        {
            ...
            ILG.Codex2007.
            Sellpickerg f1 = new ILG.Codex2007.Sellpickerg(LockupTables.Tables["CodexPS_DStatus"], 0, "C_ID", "C_Status", "C_Caption", "დოკუმენტის სტატუსი", " ", dc.X, dc.Y, Codex_Status_Edit.Width + Codex_Status_Button.Width);
        ...
        private String Codex_GenerateFindSQL()
        {
            ...
            String Fields = "C_ID,C_Caption,C_Author,C_Subject,C_Type,C_Words,C_Number,C_Date,C_lastEdit,C_EnterDate,C_Status,C_DocEncoding,C_NumberStr,C_Status,C_Coments,C_Category,C_Addtional,C_Group,C_DocFormat,(CASE (ISNULL(DATALENGTH(C_Attach),0)) WHEN 0 THEN 0  ELSE 1 END) AS L_AttachmentSize";
            String StrHeader = "SELECT " + Fields + " FROM CodexPS_DDOCS WHERE ";
            String Strd = "( ( C_Date >= " +
