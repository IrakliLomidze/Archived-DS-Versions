...
namespace ILG.Codex.Codex2007
{
    public partial class Form1 : Form
    {
        ...
        public void LoadTables()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter(
                                       ...
                                       "SELECT * FROM CodexPS_DCategory ORDER By C_Order;" + //categ
                                       "SELECT * FROM CodexPS_DStatus ORDER By C_Order;"+    // sta
                ...
                dtm9 = da.TableMappings.Add("Table6", "CodexPS");
        ...
        {
            #region Codex
                if (ILG.Codex.Codex2007.Properties.Settings.Default.DockDS == 1)
                {
                    try
                    {
                        this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
                        string fn = ILG.Codex.Codex2007.Properties.Settings.Default.DockSettingsPath + "\\Docks_CodexPS.bin";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // Set Default Views
            #region Views
                if ((ILG.Codex.Codex2007.Properties.Settings.Default.ViewDS == 0) || (ILG.Codex.Codex2007.Properties.Settings.Default.ViewDS == 1))
                { CodexViewLayout = ILG.Codex.Codex2007.Properties.Settings.Default.ViewDS; }

            #endregion Views

            #region Zoom
                if (
                      ((ILG.Codex.Codex2007.Properties.Settings.Default.ZoomDS >= 10) && (ILG.Codex.Codex2007.Properties.Settings.Default.ZoomDS <= 400))
                      ||
                      ((ILG.Codex.Codex2007.Properties.Settings.Default.ZoomDS == -10) || (ILG.Codex.Codex2007.Properties.Settings.Default.ZoomDS == -20))
                    )
                {
                    CodexZoomFactor = ILG.Codex.Codex2007.Properties.Settings.Default.ZoomDS;
                }
...
//            zf3.Entries.Extract(str, fn);
  //          zf3.Close();
            ...
            switch (ActiveProgram)
            {
                ...
                case 2:
                    #region Codex
                    {
                        ...
                        {
                            case 0: /* Find Form */ this.Text = Ind + "კოდექსი R3 დოკუმენტების პერსონალური არქივი"; break;
                            case 1: /* List Form */ this.Text = Ind + "კოდექსი R3 დოკუმენტების პერსონალური არქივი დოკუმენტების სია"; break;
        ...
        private void Codex_FillResult(String strcmd)
        {
            ...
            LockupTables.Tables["CodexPS_DAuthor"].PrimaryKey = new DataColumn[] { LockupTables.Tables["CodexPS_DAuthor"].Columns["A_ID"] };
            LockupTables.Tables["CodexPS_DType"].PrimaryKey = new DataColumn[] { LockupTables.Tables["CodexPS_DType"].Columns["T_ID"] };
            LockupTables.Tables["CodexPS_DStatus"].PrimaryKey = new DataColumn[] { LockupTables.Tables["CodexPS_DStatus"].Columns["C_ID"] };
            LockupTables.Tables["CodexPS_DCategory"].PrimaryKey = new DataColumn[] { LockupTables.Tables["CodexPS_DCategory"].Columns["C_ID"] };
            ...
            for (int i = 0; i <= Codex_Result.Tables[0].Rows.Count - 1; i++)
            {
                ...
                dr = LockupTables.Tables["CodexPS_DAuthor"].Rows.Find((int)Codex_Result.Tables[0].Rows[i]["C_Author"]);
             
                if (dr == null) Strauthor.Append(" ");
                else Strauthor.Append(@dr["A_Caption"].ToString().Trim());

                dr = LockupTables.Tables["CodexPS_DType"].Rows.Find((int)Codex_Result.Tables[0].Rows[i]["C_Type"]);
                ...
                // New ITEMS
                dr = LockupTables.Tables["CodexPS_DStatus"].Rows.Find((int)Codex_Result.Tables[0].Rows[i]["C_Status"]);
                ...
                dr = LockupTables.Tables["CodexPS_DCategory"].Rows.Find((int)Codex_Result.Tables[0].Rows[i]["C_Category"]);
