...
namespace ILG.Codex.Codex2007
{
    public partial class Form_Test_Document : Form
    {
        ...
        public int CodexOpenTestDocument(int ID )
        {
            ...
            MainForm.LockupTables.Tables["CodexPS_DAuthor"].PrimaryKey = new DataColumn[] { MainForm.LockupTables.Tables["CodexPS_DAuthor"].Columns["A_ID"] };
            MainForm.LockupTables.Tables["CodexPS_DType"].PrimaryKey = new DataColumn[] { MainForm.LockupTables.Tables["CodexPS_DType"].Columns["T_ID"] };
            MainForm.LockupTables.Tables["CodexPS_DStatus"].PrimaryKey = new DataColumn[] { MainForm.LockupTables.Tables["CodexPS_DStatus"].Columns["C_ID"] };
            MainForm.LockupTables.Tables["CodexPS_DCategory"].PrimaryKey = new DataColumn[] { MainForm.LockupTables.Tables["CodexPS_DCategory"].Columns["C_ID"] };
            ...
            dr = MainForm.LockupTables.Tables["CodexPS_DAuthor"].Rows.Find((int)dst.Tables[0].Rows[0]["C_Author"]);
            if (dr == null) Strauthor.Append(" "); else Strauthor.Append(@dr["A_Caption"].ToString().Trim());

            dr = MainForm.LockupTables.Tables["CodexPS_DType"].Rows.Find((int)dst.Tables[0].Rows[0]["C_Type"]);
            if (dr == null) Strtype.Append(" "); else Strtype.Append(@dr["T_Caption"].ToString().Trim());

            // New ITEMS
            dr = MainForm.LockupTables.Tables["CodexPS_DStatus"].Rows.Find((int)dst.Tables[0].Rows[0]["C_Status"]);
            ...
            dr = MainForm.LockupTables.Tables["CodexPS_DCategory"].Rows.Find((int)dst.Tables[0].Rows[0]["C_Category"]);
        ...
        private int detectzoom(int c)
        {
            ...
            int nPageWidthInPixels = (textControl_Codex.PageSize.Width
                // - F_CGL_DOC.textControl_CGL.PageSize.PageMargins.Left - F_CGL_DOC.textControl_CGL.PageMargins.Right
                                       );
            int nPageHeightInPixels = (textControl_Codex.PageSize.Height
