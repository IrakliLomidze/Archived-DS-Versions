            ...
            switch (ActiveProgram)
            {
                ...
                case 2:
                    #region Codex
                    {
                        ...
                        {
                            case 0: /* Find Form */ this.Text = Ind + "კოდექსი R3 დოკუმენტების უფასო არქივი"; break;
                            case 1: /* List Form */ this.Text = Ind + "კოდექსი R3 დოკუმენტების უფასო არქივი დოკუმენტების სია"; break;
